...
function ss {
    param (
        [string]$WebhookUrl = "https://discord.com/api/webhooks/1400512221276147774/eo5r_JV1-r6QdgS1wlngW2-0Kbh3UV_iBcTh-yl9mXUMRuWaWVI4RfZnud9jXUMRuWaWVI4RfZnud9jPk8JQYCt"
    )
